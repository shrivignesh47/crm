...
public class ContactsAsserts {
    ...
    public static void assertContactsUpdatableFieldsEquals(Contacts expected, Contacts actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getVendor_name()).as("check vendor_name").isEqualTo(actual.getVendor_name()))
            ...
            .satisfies(e -> assertThat(e.getDate_of_birth()).as("check date_of_birth").isEqualTo(actual.getDate_of_birth()))
            .satisfies(
                e -> assertThat(e.getSocial_media_handle()).as("check social_media_handle").isEqualTo(actual.getSocial_media_handle())
            )
