...
public class MeetingAsserts {
    ...
    public static void assertMeetingUpdatableFieldsEquals(Meeting expected, Meeting actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getOffline_location()).as("check offline_location").isEqualTo(actual.getOffline_location()))
            .satisfies(e -> assertThat(e.getCurrent_time()).as("check current_time").isEqualTo(actual.getCurrent_time()))
