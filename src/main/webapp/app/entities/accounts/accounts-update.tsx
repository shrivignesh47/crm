...
import { ownership } from 'app/shared/model/enumerations/ownership.model';
import { getEntity, updateEntity, createEntity, reset } from './accounts.reducer';
import './AccountsUpdate.css';  // Import the CSS file
...
export const AccountsUpdate = () => {
  ...
  return (
    <div className="accounts-update-container">
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="crmApp.accounts.home.createOrEditLabel" data-cy="AccountsCreateUpdateHeading" className="accounts-update-header">
      ...
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            <p className="accounts-update-loading">Loading...</p>
          ) : (
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity} className="accounts-update-form">
              {!isNew ? <ValidatedField name="id" required readOnly id="accounts-id" label="ID" validate={{ required: true }} className="accounts-update-field" /> : null}
              <ValidatedField
                label="Account Owner"
                id="accounts-account_owner"
                name="account_owner"
                ...
                className="accounts-update-field"
              />
              <ValidatedField label="Rating" id="accounts-rating" name="rating" data-cy="rating" type="select" className="accounts-update-field">
                {ratingValues.map(rating => (
                  <option value={rating} key={rating}>
                    {rating}
                  </option>
              ...
              <ValidatedField
                ...
                className="accounts-update-field"
              />
              <ValidatedField label="Fax" id="accounts-fax" name="fax" data-cy="fax" type="text" className="accounts-update-field" />
              <ValidatedField
                label="Website"
                id="accounts-website"
                name="website"
              ...
              <ValidatedField
                ...
                className="accounts-update-field"
              />
              <ValidatedField label="Ticket Symbol" id="accounts-ticket_Symbol" name="ticket_Symbol" data-cy="ticket_Symbol" type="text" className="accounts-update-field" />
              <ValidatedField label="Account Type" id="accounts-account_type" name="account_type" data-cy="account_type" type="select" className="accounts-update-field">
                {typeValues.map(type => (
                  <option value={type} key={type}>
                    {type}
                  </option>
              ...
              <ValidatedField label="Ownership" id="accounts-ownership" name="ownership" data-cy="ownership" type="select" className="accounts-update-field">
                {ownershipValues.map(ownership => (
                  <option value={ownership} key={ownership}>
                    {ownership}
                  </option>
              ...
              <ValidatedField
                ...
                className="accounts-update-field"
              />
              <ValidatedField label="Shipping City" id="accounts-shipping_city" name="shipping_city" data-cy="shipping_city" type="text" className="accounts-update-field" />
              <ValidatedField label="Shipping State" id="accounts-shipping_state" name="shipping_state" data-cy="shipping_state" type="text" className="accounts-update-field" />
              <ValidatedField label="Shipping Code" id="accounts-shipping_code" name="shipping_code" data-cy="shipping_code" type="text" className="accounts-update-field" />
              <ValidatedField label="Shipping Country" id="accounts-shipping_country" name="shipping_country" data-cy="shipping_country" type="text" className="accounts-update-field" />
              <ValidatedField
                label="Description"
                id="accounts-description"
                name="description"
              ...
              <ValidatedField
                ...
                className="accounts-update-field"
              />
              <ValidatedField label="Sic Code" id="accounts-sic_code" name="sic_code" data-cy="sic_code" type="text" className="accounts-update-field" />
              <div className="accounts-update-buttons">
                <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/accounts" replace color="info" className="accounts-update-button accounts-update-cancel-button">
                  <FontAwesomeIcon icon="arrow-left" />
                  &nbsp;
                  <span className="d-none d-md-inline">Back</span>
                </Button>
                &nbsp;
                <Button color="primary" id="save-entity" data-cy="entityCreateSaveButton" type="submit" disabled={updating} className="accounts-update-button accounts-update-save-button">
                  <FontAwesomeIcon icon="save" />
                  &nbsp; Save
                </Button>
              </div>
