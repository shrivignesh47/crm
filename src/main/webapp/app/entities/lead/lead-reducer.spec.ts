...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lead.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEAD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEAD actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_LEAD actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_LEAD actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_LEAD actions', async () => {
      const arg = 42666;
