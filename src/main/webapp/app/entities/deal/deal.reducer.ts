...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IDeal, thunkAPI) => {
    const result = await axios.post<IDeal>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  'deal/update_entity',
  async (entity: IDeal, thunkAPI) => {
    const result = await axios.put<IDeal>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IDeal, thunkAPI) => {
    const result = await axios.patch<IDeal>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<IDeal>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
