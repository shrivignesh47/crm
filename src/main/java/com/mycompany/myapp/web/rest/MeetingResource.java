...
public class MeetingResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<Meeting>> createMeeting(@Valid @RequestBody Meeting meeting) throws URISyntaxException {
     ...
     */
    @PutMapping("/{id}")
    public Mono<ResponseEntity<Meeting>> updateMeeting(
    ...
    public Mono<ResponseEntity<Meeting>> partialUpdateMeeting(
        @PathVariable(value = "id", required = false) final String id,
        ...
        return meetingRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<Meeting> result = meetingService.partialUpdate(meeting);
    ...
    public Mono<ResponseEntity<List<Meeting>>> getAllMeetings(
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<Meeting>> getMeeting(@PathVariable("id") String id) {
        log.debug("REST request to get Meeting : {}", id);
        Mono<Meeting> meeting = meetingService.findOne(id);
